		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Skills UI testing",
									"targetURL": "#projectskillsuitest-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"projectskillsuitest-display": {
								"semanticObject": "projectskillsuitest",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=projectskillsuitest",
									"url": sap.ui.require.toUrl("projectskillsuitest")
								}
							}
						}
					}
