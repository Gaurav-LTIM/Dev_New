		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#projectxsuaaui2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"projectxsuaaui2-display": {
								"semanticObject": "projectxsuaaui2",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=projectxsuaaui2",
									"url": sap.ui.require.toUrl("projectxsuaaui2")
								}
							}
						}
					}
