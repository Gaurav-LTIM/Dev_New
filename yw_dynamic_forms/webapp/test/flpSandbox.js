		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Yorkshire Demo",
									"targetURL": "#ywdynamicforms-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ywdynamicforms-display": {
								"semanticObject": "ywdynamicforms",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ywdynamicforms",
									"url": sap.ui.require.toUrl("ywdynamicforms")
								}
							}
						}
					}
